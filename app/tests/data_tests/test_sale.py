...
from app.data_layer.sales import create_sale, get_sale_by_id, update_sale, delete_sale, get_sales, get_sales_by_organisation
...
def test_update_sale(db_session):
    ...
    result = update_sale(session=db_session, sale_id=created_sale.id, sale_update=update_data)
...
def test_get_sales_by_organisation(db_session):
    ...
    results_org1 = get_sales_by_organisation(session=db_session, organisation_id=org1.id)
    results_org2 = get_sales_by_organisation(session=db_session, organisation_id=org2.id)
